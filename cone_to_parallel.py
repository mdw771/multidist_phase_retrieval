...
data, d_para_cm = convert_cone_to_parallel(data, 390, np.array([47.4848, 47.3848, 46.9848, 45.9847]))
dxchange.write_tiff_stack(data, 'data/vincent/test/converted', dtype='float32', overwrite=True)
print(d_para_cm)